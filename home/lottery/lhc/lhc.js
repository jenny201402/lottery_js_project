...
$(function() {
    mui.plusReady(function() {
        ...
        var vmodel = avalon.define({
            ...
            road: function () {//路珠
                delay_till_last('click', function() {
                    plus.webview.create('../../lotteryRecord/road/kl8road.html', 'record.road.kl8', {
                        bounce: 'none',
                        'popGesture':'close'
                    },{
                        gameId: vmodel.lotteryID,
            ...
            $skipArray: ['tabChange','moneyHandler','menuViewHandler','winLose','road','towFace','gamaRules','openResult','bettingList','todayFinish','nowBetting','chooseType','chooseHandler','resetBettingChoose','betting','cancelDialog','chooseMoney','clearMoney','showChouma','getOdds','changeView','menuList']
        })
        ...
        //判断双面结果
        function smResult(obj){
            vmodel.smResult = [obj.n1_sx,obj.n2_sx,obj.n3_sx,obj.n4_sx,obj.n5_sx,obj.n6_sx,obj.n7_sx,]
        }
        //获取菜单小数据
        ...
        plus.webview.show("base.lhc", "slide-in-right", 300, function() {
